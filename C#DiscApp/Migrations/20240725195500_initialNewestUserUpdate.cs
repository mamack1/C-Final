...
{
    /// <inheritdoc />
    public partial class initialNewestUserUpdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Disc_Fade", "[Fade] >= 0 AND [Fade] <= 5");
                    table.CheckConstraint("CK_Disc_Glide", "[Glide] >= 1 AND [Glide] <= 7");
                    table.CheckConstraint("CK_Disc_Speed", "[Speed] >= 1 AND [Speed] <= 15");
                    table.CheckConstraint("CK_Disc_Turn", "[Turn] >= -5 AND [Turn] <= 5");
                    table.ForeignKey(
